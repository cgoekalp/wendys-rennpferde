...
public class HorseJockeyCombination implements Comparable{
    ...
    public HorseJockeyCombination(Integer id, Integer rank, String horseName, String jockeyName, Double avgSpeed, Double horseSpeed, Double skill, Double luckFactor) {
        this.rank = rank;
    ...
    public boolean equals(Object o) {
        ...
        HorseJockeyCombination that = (HorseJockeyCombination) o;
    ...
    public int compareTo(Object o) {
        ...
        HorseJockeyCombination tmp = (HorseJockeyCombination)o;

        return Double.compare(avgSpeed, tmp.getAvgSpeed()) * -1;
    }
}
